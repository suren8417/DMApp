<div  style="margin:0px 100px 30px 100px; background-color: #ffffff; border:1px solid #e7e7e7;height:100%;">
   <div class="row" ng-controller="newItemController">
       <fieldset ng-disabled="showLodaing">
       <div ng-show="showLodaing" style="width: 100%;height: 100%;"> <img src="images/loading45.gif" style="position: absolute;left: 50%;top: 80%; margin-left: -32px; margin-top: -32px;z-index: 1000;" > </div>

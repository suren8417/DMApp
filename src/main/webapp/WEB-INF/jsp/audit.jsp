<div style="margin:0px 100px 0px 100px; background-color: #ffffff; border:1px solid #e7e7e7;height:100%;">
	...
	<legend style="width:94%; margin-left:30px;"><h3><b style="color:#1D1F5A;">Audit Items</b></h3></legend>
        <div style=" margin-left: 50px;margin-right: 50px;margin-top: 30px;margin-bottom: 30px;">
            ...
            <div class="row" style="margin-bottom:20px">
                ...
                <div class="col-md-7">
                    <input type="text" id="itemName" name="itemName" placeholder="" ng-model="itemName"  class="form-control" maxlength="250">
                </div>
                ...
                <div class="col-md-3">
                    <div class="controls">
                      ...
                      <%--  </p>--%>
                       <%-- <p style="color:red" ng-show="userNameRequired"><span class="glyphicon glyphicon-exclamation-sign"></span> Please select user</p>--%>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-bottom:20px">
                ...
                <div class="col-md-2">
                    <div class="controls">
                        <button class="btn" style="width: 100px;" ng-click="search(itemName,selectedUser,startDate,endDate)">Search</button>
                    </div>
                </div>
            </div>
